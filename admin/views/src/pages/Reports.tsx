        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="center">
            ...
            >
              ...
              <p className="font-bold text-gray-600 text-xs">Copy email</p>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <p className="font-bold text-xs text-red-600">Disable account</p>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <p className="font-bold text-xs text-red-900">Delete account</p>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
