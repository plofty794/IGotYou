...
const columns: ColumnDef<TPreviousReservations>[] = [
  {
    accessorKey: "status",
    header: ({ column }) => {
      return (
...
function PreviousReservationsTable({
  data,
}: {
  data: TPreviousReservations[];
}) {
...
export default PreviousReservationsTable;
