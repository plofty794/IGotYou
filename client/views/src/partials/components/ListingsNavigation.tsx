...
function ListingsNavigation() {
  ...
  return (
    <>
      <div className="flex items-center justify-center gap-4 p-8 max-md:w-full max-md:p-4">
        <span className="w-2/4 text-3xl font-bold">{pathname}</span>
        <Swiper
          slidesPerView={4}
          spaceBetween={30}
          pagination={{
        ...
        <Button
          variant={"secondary"}
          className="p-6 border flex items-center justify-center gap-2 rounded-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
