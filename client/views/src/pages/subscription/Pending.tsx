  ...
  return (
    <div className="bg-[#F5F5F5] min-h-screen flex items-center justify-center">
      <Card className="p-4 flex flex-col justify-center shadow-lg border">
        ...
        <CardDescription className="px-6 pb-4 text-lg font-bold text-[#222222]">
          Hello {user.username},
        </CardDescription>
        <CardContent className="flex flex-col gap-2 pb-4 text-xs text-zinc-700 w-[500px] font-semibold">
          <span>
        ...
        <CardFooter className="text-xs font-semibold text-zinc-700">
          Sincerely, The IGotYou Team
        </CardFooter>
        <Button className="ml-auto w-max px-6 font-bold text-xs rounded-full bg-[#222222] text-white mb-2 mr-4">
          <Link to={"/"} replace>
            {" "}
            Go back
          </Link>
