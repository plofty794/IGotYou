    ...
    <section className="flex gap-4 p-4">
      <div className="flex w-1/3 flex-col gap-2">
        <div className="flex w-full items-center justify-between">
          <h1 className="gap-2 text-2xl font-bold max-md:hidden max-md:text-lg">
            Booking requests
          </h1>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger className="max-md:w-full" asChild>
                <Button
                  onClick={() => {
        ...
        <div className="flex w-full items-center justify-between gap-2 max-lg:flex-col">
          <Input
            value={username}
        ...
        {guests?.length > 0 ? (
          <>
            <ScrollArea className="mt-2 h-max max-h-[484px]">
              <div className="inbox mt-2 flex w-full flex-col gap-4 max-md:gap-2">
                {guests.map(
                  ...
                  (v: any) =>
                    v.type == "Service-Cancellation-Request" ? (
                      ...
                      >
                        <div className="flex gap-2 px-4 py-2 max-lg:p-2">
                          {matches ? (
                            <>
                              <Avatar className="max-sm:mx-auto">
                                <AvatarImage
