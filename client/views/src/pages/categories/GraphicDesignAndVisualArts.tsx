...
function GraphicDesignAndVisualArts() {
  const { data, fetchNextPage, error, isPending, isFetchingNextPage } =
    useGetListingsPerCategory<TCategories>("Graphic Design and Visual Arts");
  ...
  useEffect(() => {
    document.title = "Graphic Design and Visual Arts - IGotYou";
  }, []);
...
export default GraphicDesignAndVisualArts;
